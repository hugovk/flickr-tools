...
ALWAYS_TAGS = ['hvk', 'hugovk'] # TODO change this to your own username, for example
...
def expand_tags(tag_to_find, expanded_tags, source_tags, result_tags):
    """Expand tag to a list of expanded tags. For example, expand 'Helsinki' to 'Helsingfors', 'Finland', 'Suomi'"""
...
def set_standard_tags(photo_id, make, model, timestring, flickr_tags):
    ...
    for expandable in EXPANDABLES:
        expand_tags(expandable[0], expandable[1],
    ...
    if timestring:
        ...
        # WARNING! Works only in the northern hemisphere and assumes clockwork seasons!
...
if __name__ == "__main__":
    ...
    parser.add_argument('-j', '--jatkuu', action='store_true',
