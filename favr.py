...
if __name__ == "__main__":
    ...
    for fave in faves:
        ...
        print_it(
            photo_id + "\t" + fave.find('stats').get('favorites')
            + "*\t" + fave.get('title'))
